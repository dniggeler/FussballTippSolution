...
namespace WMTippApp.Controllers
{
    public class EmailReminderController : Controller
    {
        ...
        private IFussballDataRepository _matchDataRepository = new WMFussballDataRepository(SportsdataConfigInfo.Current);
        ...
        private void SendEmail(string username, string email)
        {
            ...
            msg.To.Add(email);
            msg.Subject = "WM-Tippspiel: Reminder";
            msg.Body = "Hallo " + username + "," + Environment.NewLine + Environment.NewLine +
                        @"Du hast für ein oder mehrere Spiele, die in Kürze beginnen, noch Tipps offen." +
